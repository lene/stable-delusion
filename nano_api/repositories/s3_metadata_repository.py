...
from nano_api.repositories.interfaces import MetadataRepository
...
class S3MetadataRepository(MetadataRepository):
    ...
    def __init__(self, config: Config):
        """
        Initialize S3 metadata repository.
        ...
        try:
            ...
            self.s3_client.put_object(
                ...
                Metadata={
                    ...
                    'prompt-preview': (metadata.prompt[:100] + '...'
                                       if len(metadata.prompt) > 100 else metadata.prompt)
                }
            )
