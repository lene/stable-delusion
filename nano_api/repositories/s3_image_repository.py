...
from nano_api.repositories.s3_client import S3ClientManager, generate_s3_key, build_s3_url
...
class S3ImageRepository(ImageRepository):
    ...
    def _extract_s3_key(self, file_path: Path) -> str:
        ...
        if path_str.startswith(("https://", "http://", "https:/", "http:/")):
            from nano_api.repositories.s3_client import parse_https_s3_url
